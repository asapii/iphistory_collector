...
if __name__ == '__main__':
    ...
    output_csv = output_dir + "\\iphistory.csv"
    ...
    with open(output_csv,"w",newline="") as f:
        ...
        with open(output_dir + "\\parsed_lwtnetlog_utf8.txt","r") as txt:
            for row in txt:
                write_list = func.get_listforcsv(row)
                if func.check_ipv4_privateornone(write_list[3]):
                    """write to csv only privateipv4 or none of ipv4"""
